...
# Archived: AIRBNB_COMPARISON.md

This strategic comparison has been deprecated in favor of living documentation:

- See README.md for current overview and features
- See DOCUMENTATION_INDEX.md for active guides
- See SYSTEM_REVIEW.md for the latest production-grade review

Payments and some roadmap items are deferred; focus areas now include chat integrity, Favorites, Reviews, and e2e stability.
