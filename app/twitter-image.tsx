...
export default function TwitterImage() {
  // Reuse the same design as OG for consistent previews.
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          >
            ...
            <span style={{ opacity: 0.9, fontWeight: 600, fontSize: 18 }}>
        ...
        >
          <div style={{ color: 'rgba(255,255,255,0.92)', fontSize: 22, fontWeight: 600 }}>
            resortifyph.me
          </div>
          <div style={{ color: 'rgba(255,255,255,0.8)', fontSize: 18, fontWeight: 600 }}>
            Explore • Chat • Book
          </div>
        </div>
      </div>
