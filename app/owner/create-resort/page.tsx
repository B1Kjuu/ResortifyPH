...
export default function CreateResort(){
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-10 max-w-2xl mx-auto">
      ...
      <h1 className="text-3xl font-bold text-resort-900 mb-2">Create New Resort</h1>
      <p className="text-slate-600 mb-8">Submit your resort for approval. Fill in all details carefully.</p>
      ...
      <form onSubmit={handleCreate} className="bg-white border border-slate-200 rounded-lg p-6 space-y-4">
        ...
        <div className="flex gap-3 pt-4">
          ...
          <Link href="/owner/dashboard" className="flex-1 px-4 py-2 border border-slate-300 rounded-lg font-semibold text-center hover:bg-slate-50 transition">
            Cancel
          </Link>
        </div>
      </form>
