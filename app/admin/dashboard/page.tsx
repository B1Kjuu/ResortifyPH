  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-10 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <Link href="/admin/resorts" className="bg-resort-teal text-white rounded-lg p-6 hover:bg-resort-teal-dark transition">
        ...
        <Link href="/admin/bookings-management" className="bg-resort-500 text-white rounded-lg p-6 hover:bg-resort-600 transition">
          <div className="text-4xl mb-3">📋</div>
