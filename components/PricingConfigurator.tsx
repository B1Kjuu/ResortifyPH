                  ...
                  <table className="w-full text-sm min-w-[400px]">
                    <thead>
                      <tr className="bg-slate-100">
                        <th className="px-2 sm:px-3 py-2 text-left font-medium text-slate-600 rounded-tl-lg text-xs sm:text-sm">Guest Tier</th>
                        <th className="px-2 sm:px-3 py-2 text-center font-medium text-slate-600 text-xs sm:text-sm">
                          <span className="flex items-center justify-center gap-1">
                            <FiSun className="w-3 h-3 sm:w-4 sm:h-4" /> <span className="hidden sm:inline">Weekday</span><span className="sm:hidden">Wkday</span>
                          </span>
                        </th>
                        <th className="px-2 sm:px-3 py-2 text-center font-medium text-slate-600 rounded-tr-lg text-xs sm:text-sm">
                          <span className="flex items-center justify-center gap-1">
                            <FiMoon className="w-3 h-3 sm:w-4 sm:h-4" /> <span className="hidden sm:inline">Weekend/Holiday</span><span className="sm:hidden">Wkend</span>
                          </span>
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      {config.guestTiers.map((tier, idx) => (
                        <tr key={tier.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
                          <td className="px-2 sm:px-3 py-2 font-medium text-slate-700 text-xs sm:text-sm">{tier.label}</td>
                          <td className="px-1 sm:px-3 py-2">
                            <div className="relative">
                              ...
                              <input
                                ...
                                placeholder="0"
                                className="w-full pl-6 sm:pl-8 pr-1 sm:pr-3 py-1.5 sm:py-2 border border-slate-300 rounded-lg text-right text-xs sm:text-sm focus:ring-2 focus:ring-amber-400"
                              />
                            </div>
                          </td>
                          <td className="px-1 sm:px-3 py-2">
